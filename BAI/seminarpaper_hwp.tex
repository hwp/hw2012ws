...
Different from directed replication via module assembly, which applies ``pick-and-place'' technique, self-replication of modular robots can also be realized using 
