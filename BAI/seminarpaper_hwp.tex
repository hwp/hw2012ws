...
There are 3 types of basic modules (white, black and red). Figure \ref{fig:matsu-mod} shows their structure. The cubic unit has mortise and tenon on top and bottom surfaces. Modules of the same type have the complementary structure of mortise and tenon, while modules of different types do not. Thus, the selectivity of matching types is aquired. The solder on the top and bottem surfaces, as well as the hot-melt adhesive on the side surfaces, provides the unit with two kinds of bonds. These two kinds of bonds corresonds to the %TODO DNA



\begin{figure}[t]
	 \centerline{\includegraphics[width=.8\textwidth]{matsu-001}}
	 {\caption{Design of the basic module. (from \cite{matsumoto_passive_2009})}
	 \label{fig:matsu-mod}}
\end{figure}

\begin{figure}[t]
	 \centerline{\includegraphics[width=.6\textwidth]{matsu-003}}
	 {\caption{Apparatus for experiment. (from \cite{matsumoto_passive_2009})}
	 \label{fig:matsu-env}}
\end{figure}

\begin{figure}[t]
	 \centerline{\includegraphics[width=.8\textwidth]{matsu-019}}
