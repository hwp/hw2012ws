...
The replication process is performed on an air table, on which the modules moves randomly. A 5-bit string (5 linearly connected modules) is priorly prepared as the template. Then, %TODO
