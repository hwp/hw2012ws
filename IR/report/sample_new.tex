...
\tikzset{
  ...
  level 2/.style = {basic, rounded corners=6pt, thin,align=center, fill=green!60,
                    text width=25mm},
  level 3/.style = {basic, thin, align=left, fill=pink!60, text width=20mm}
}
...
ROS system on disk consists of a hierarchical filesystem. The filesystem concepts (from large to small) are stacks, packages, nodes, messages and services. Figure \ref{fig:filesystem} shows the relation between thess concepts.
...
% The first level, as children of the initial tree
  child {node[level 2] (c1) {Stack}}
  child {node[level 2] (c2) {Stack}}
  child {node[level 2] (c3) {Stack}};

% The second level, relatively positioned nodes
\begin{scope}[every node/.style={level 3}]
\node [below of = c1, xshift=15pt] (c11) {Package};
\node [below of = c11] (c12) {Package};
\node [below of = c12] (c13) {Package};

\node [below of = c2, xshift=15pt] (c21) {Package};
\node [below of = c21] (c22) {Package};
\node [below of = c22] (c23) {Package};
\node [below of = c23] (c24) {Package};
\node [below of = c24] (c25) {Package};

\node [below of = c3, xshift=15pt] (c31) {Package};
\node [below of = c31] (c32) {Package};
\end{scope}
